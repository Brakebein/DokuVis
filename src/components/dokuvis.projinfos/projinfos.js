 ...
 */
.directive('projinfoList', ['$rootScope', 'ProjInfo', 'Utilities', 'ConfirmDialog',
	function ($rootScope, ProjInfo, Utilities, ConfirmDialog) {

		return {
			restrict: 'E',
			templateUrl: 'components/dokuvis.projinfos/projinfoList.tpl.html',
			scope: {},
			link: function (scope) {
