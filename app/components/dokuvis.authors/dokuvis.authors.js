 ...
 * @scope
 */
.directive('authorList', ['ComponentsPath', 'Author', 'Utilities',
	function (ComponentsPath, Author, Utilities) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.authors/authorList.tpl.html',
			scope: {},
			link: function (scope) {
