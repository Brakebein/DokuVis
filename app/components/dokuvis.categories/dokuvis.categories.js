 ...
 *
 * ### Requirements
 * Add `dokuvis.categories.js` and `dokuvis.categories.css` to your `index.html` and add `dokuvis.categories` as dependency.
 *
 ...
 * @scope
 */
.directive('categoryList', ['$rootScope', 'ComponentsPath', 'Category', 'Utilities',
	function ($rootScope, ComponentsPath, Category, Utilities) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.categories/categoryList.tpl.html',
			scope: {},
			link: function (scope) {
 ...
 * @scope
 */
.directive('categoryConfig', ['$rootScope', 'ComponentsPath', 'Category', 'CategoryAttribute', 'Utilities',
	function ($rootScope, ComponentsPath, Category, CategoryAttribute, Utilities) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.categories/categoryConfig.tpl.html',
			scope: {},
			link: function (scope) {
...
.directive('categoryLegend', ['ComponentsPath',
	function (ComponentsPath) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.categories/categoryLegend.tpl.html',
			scope: {},
