 ...
 * @restrict E
 * @scope
 * @param config {Array<string>=} Show config buttons in additional column. Available buttons are displayed by following strings: `edit`, `remove`, more to come...
 */
.directive('staffList', ['ComponentsPath', 'Staff', 'Utilities',
	function (ComponentsPath, Staff, Utilities) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.staff/staffList.tpl.html',
			scope: {
				configArray: '<config'
			},
			link: function (scope) {
