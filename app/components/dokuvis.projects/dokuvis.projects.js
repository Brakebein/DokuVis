 ...
 */
.directive('projectList', ['$window', '$state', 'ComponentsPath', 'Project', 'Utilities', 'ConfirmDialog',
	function ($window, $state, ComponentsPath, Project, Utilities, ConfirmDialog) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.projects/projectList.tpl.html',
			scope: {},
			link: function (scope) {
