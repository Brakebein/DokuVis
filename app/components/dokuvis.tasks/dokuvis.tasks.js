 ...
 * @scope
 */
.directive('tasksGantt', ['$rootScope', '$timeout', '$q', 'moment', 'ComponentsPath', 'Task', 'Subproject', 'Staff', 'Utilities',
	function ($rootScope, $timeout, $q, moment, ComponentsPath, Task, Subproject, Staff, Utilities) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.tasks/tasksGantt.tpl.html',
			scope: {},
			link: function (scope) {
 ...
 * @scope
 */
.directive('taskDetail', ['$rootScope', 'ComponentsPath', 'Utilities',
	function ($rootScope, ComponentsPath, Utilities) {

		return {
			restrict: 'E',
			templateUrl: ComponentsPath + '/dokuvis.tasks/taskDetail.tpl.html',
			scope: {},
			link: function (scope) {
