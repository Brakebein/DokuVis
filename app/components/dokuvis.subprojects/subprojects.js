 ...
 * @restrict E
 */
.directive('subprojectList', ['Subproject', 'Utilities', 'AclService',
	function (Subproject, Utilities, AclService) {

		return {
			restrict: 'E',
			templateUrl: 'components/dokuvis.subprojects/subprojectList.tpl.html',
			scope: {},
			link: function (scope) {
