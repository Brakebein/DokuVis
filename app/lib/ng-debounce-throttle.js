 ...
 * @param leading {boolean=} If true, the function is triggered on the leading instead of the trailing edge of the **delay** interval. Useful for circumstances like preventing accidental double-clicks on a "submit" button from firing a second time. Default: `false`
 * @param invokeApply {boolean=} If true, an angular digest cycle is triggered (see $timeout service for more details). Default: `true`
 ...
 * @param leading {boolean=} If true, the function will be invoked at the startup. Default: `false`
 * @param trailing {boolean=} If true, the function will be invoked at end of the operation. Default: `true`
 * @param invokeApply {boolean=} If true, an an angular digest cycle is triggered each time the function is invoked. Default: `false`
